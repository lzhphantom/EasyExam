...
public class RetOps<T> {
     ...
     * 状态码为成功
     */
    public static final Predicate<LzhphantomResult<?>> CODE_SUCCESS = r -> CommonConstants.SUCCESS == r.getCode();

    /**
     * 数据有值
     */
    public static final Predicate<LzhphantomResult<?>> HAS_DATA = r -> ObjectUtil.isNotEmpty(r.getData());

    /**
     * 数据有值,并且包含元素
     */
    public static final Predicate<LzhphantomResult<?>> HAS_ELEMENT = r -> ObjectUtil.isNotEmpty(r.getData());

    /**
     * 状态码为成功并且有值
     */
    public static final Predicate<LzhphantomResult<?>> DATA_AVAILABLE = CODE_SUCCESS.and(HAS_DATA);

    private final LzhphantomResult<T> original;

    // ~ 初始化
    // ===================================================================================================

    RetOps(LzhphantomResult<T> original) {
        this.original = original;
    }

    public static <T> RetOps<T> of(LzhphantomResult<T> original) {
     ...
     * @return R
     */
    public LzhphantomResult<T> peek() {
        return original;
    }
     ...
     */
    public Optional<T> getDataIf(Predicate<? super LzhphantomResult<?>> predicate) {
     ...
     * @throws Ex 断言失败时抛出
     */
    public <Ex extends Exception> RetOps<T> assertCode(int expect, Function<? super LzhphantomResult<T>, ? extends Ex> func)
            throws Ex {
     ...
     * @throws Ex 断言失败时抛出
     */
    public <Ex extends Exception> RetOps<T> assertSuccess(Function<? super LzhphantomResult<T>, ? extends Ex> func) throws Ex {
     ...
     * @throws Ex 断言失败时抛出
     */
    public <Ex extends Exception> RetOps<T> assertDataNotNull(Function<? super LzhphantomResult<T>, ? extends Ex> func) throws Ex {
     ...
     * @throws Ex 断言失败时抛出
     */
    public <Ex extends Exception> RetOps<T> assertDataNotEmpty(Function<? super LzhphantomResult<T>, ? extends Ex> func) throws Ex {
    ...
    public <U> RetOps<U> map(Function<? super T, ? extends U> mapper) {
        LzhphantomResult<U> result = LzhphantomResult.restResult(mapper.apply(original.getData()), original.getCode(), original.getMsg());
        return of(result);
    }
     ...
     */
    public <U> RetOps<U> mapIf(Predicate<? super LzhphantomResult<T>> predicate, Function<? super T, ? extends U> mapper) {
        LzhphantomResult<U> result = LzhphantomResult.restResult(mapper.apply(original.getData()), original.getCode(), original.getMsg());
        return of(result);
    }
     ...
     * @see RetOps#DATA_AVAILABLE
     */
    public void useDataIf(Predicate<? super LzhphantomResult<T>> predicate, Consumer<? super T> consumer) {
