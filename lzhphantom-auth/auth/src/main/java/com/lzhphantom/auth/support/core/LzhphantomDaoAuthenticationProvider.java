...
public class LzhphantomDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public LzhphantomDaoAuthenticationProvider() {
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails, UsernamePasswordAuthenticationToken authentication) throws AuthenticationException {
        // app 模式不用校验密码
        String grantType = LzhphantomWebUtils.getRequest().get().getParameter(OAuth2ParameterNames.GRANT_TYPE);
    ...
    protected UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
        ...
        HttpServletRequest request = LzhphantomWebUtils.getRequest()
                .orElseThrow(
                        (Supplier<Throwable>) () -> new InternalAuthenticationServiceException("web request is empty"));

        Map<String, String> paramMap = LzhphantomServletUtils.getParamMap(request);
        ...
        Map<String, LzhphantomUserDetailsService> userDetailsServiceMap = SpringUtil
                .getBeansOfType(LzhphantomUserDetailsService.class);

        String finalClientId = clientId;
        Optional<LzhphantomUserDetailsService> optional = userDetailsServiceMap.values()
                .stream()
