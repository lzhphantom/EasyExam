 ...
 */
@Log4j2
public class LzhphantomSentinelInvocationHandler implements InvocationHandler {
    ...
    public LzhphantomSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
            ...
            if (methodMetadata == null) {
                ...
                try {
                    ...
                    if (fallbackFactory != null) {
                        ...
                        // 若是R类型 执行自动降级返回R
                        if (LzhphantomResult.class == method.getReturnType()) {
                            log.error("feign 服务间调用异常", ex);
                            return LzhphantomResult.failed(ex.getLocalizedMessage());
                        } else {
                            throw ex;
                        }
                    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SentinelInvocationHandler) {
            LzhphantomSentinelInvocationHandler other = (LzhphantomSentinelInvocationHandler) obj;
    ...
    static Map<Method, Method> toFallbackMethod(Map<Method, InvocationHandlerFactory.MethodHandler> dispatch) {
        Map<Method, Method> result = Maps.newLinkedHashMap();
