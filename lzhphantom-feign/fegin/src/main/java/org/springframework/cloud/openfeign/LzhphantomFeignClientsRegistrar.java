...
import com.lzhphantom.fegin.LzhphantomFeignAutoConfiguration;
 ...
 */
public class LzhphantomFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
    @Getter
    ...
    private void registerFeignClients(BeanDefinitionRegistry registry) {
        ...
        List<String> feignClients = Lists.newArrayList(
    ...
    private Class<?> getSpringFactoriesLoaderFactoryClass() {
        return LzhphantomFeignAutoConfiguration.class;
    }
