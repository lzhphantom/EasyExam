...
public interface UserService extends IService<User> {
	 ...
	 */
	LzhphantomResult<Boolean> updateUserInfo(UserDTO userDto);
	 ...
	 * @return
	 */
	LzhphantomResult<Boolean> updateUser(UserDTO userDto);
	 ...
	 * @return ok fail
	 */
	LzhphantomResult importUser(List<UserExcelVO> excelVOList, BindingResult bindingResult);
	 ...
	 */
	LzhphantomResult<Boolean> registerUser(UserDTO userDto);
